    ...
    <div class="sign-up container-fluid">
        <div class="form-sign-up row mx-auto">
            ...
            <div class="col-10 col-sm-5 d-grid align-items-center">
                <form action="/signup_seller" method="post" class="bg-white p-3 rounded-2">
                    @csrf
                    <h3 class="mb-3">Daftar Seller</h3>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                <input type="text" class="form-control @error('nameSeller') is-invalid @enderror" placeholder="Nama Lengkap" name="nameSeller" value="{{ old('nameSeller') }}">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <p><span style="color: rgb(113,119,125)">Punya akun?</span>
                            <a style="color: rgb(238,77,45)" class="text-decoration-none" href="/login_seller">Log in</a>
                        </p>
                    </div>
                </form>
            </div>
