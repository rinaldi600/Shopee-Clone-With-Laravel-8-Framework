    ...
    <div class="sign-up container-fluid">
        <div class="form-sign-up row mx-auto">
            ...
            <div class="col-10 col-sm-5 d-grid align-items-center">
                <form action="/sign_seller" method="post" class="bg-white p-3 rounded-2">
                    @csrf
                    <h3 class="mb-3">Log In Seller</h3>
                    ...
                    <div class="text-center mt-3">
                        <p><span style="color: rgb(113,119,125)">Baru di Shopee?</span>
                            <a style="color: rgb(238,77,45)" class="text-decoration-none" href="/registration_seller">Daftar</a>
                        </p>
                    </div>
                </form>
            </div>
